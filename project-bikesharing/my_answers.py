...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        ###sig_hidden_output = self.activation_function(hidden_outputs)
        ...
        ##print(hidden_error_term.shape)
        ##print(X.shape)
        ##print(np.dot(X[:,None], hidden_error_term[None,:]))
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        #print(delta_weights_h_o)
        #print(delta_weights_i_h)
        #print(self.lr*delta_weights_h_o)
        #print(self.lr*delta_weights_i_h)
